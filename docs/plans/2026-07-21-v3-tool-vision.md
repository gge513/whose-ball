...
> **Step:** STRUCTURE LOCKED 2026-07-21 (all four calls George's, in session — COURSE-LOG Entry 016's session, post-close). **Build NOT STARTED, deliberately:** Week 2's comms platform (`comms-gge513`, merge Sun Jul 26 17:00 ET) builds first. Resume HERE after Week 2 ships; first move = settle the two open sub-questions below, then Session 1. Never re-derive the locks.
