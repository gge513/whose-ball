...
>
> **AWAITING GEORGE'S CALL (2026-07-16, ask at next session start):** surgical delete of his three FAKE demo rows — the Jul 13 backfill seeded him a submission (`pm-gge513`, retired repo format) + `submission_merged` + `review_filed` events, so his public narrative and journey standing claim a merged submission PR that hasn't happened. Recommended: delete his three rows now, keep the four demo peers until the real roster lands (still needed to demo the review console).
>
